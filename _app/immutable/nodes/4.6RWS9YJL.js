import"../chunks/CWj6FrbW.js";import{o as Ie}from"../chunks/B0UN5Y53.js";import{w as xe,C as Ae,n as $,G as Re,aM as ae,J as ke,K as Ce,D as Se,L as se,a9 as re,U as K,W as ie,V as oe,P as Q,v as we,M as Le,aN as ne,aO as le,aP as ce,e as He,Z as fe,_ as Y,au as Pe,p as De,al as ue,aj as Me,g as Oe,f as d,b as u,c as je,ai as $e,k as a,ak as me,d as m,ah as de,r,s as H,aQ as Ue,a as pe,aL as Z,t as J}from"../chunks/DdNfpMyg.js";import{d as Be,b as We,e as Fe,s as U}from"../chunks/BW3j7JZm.js";import{i as V}from"../chunks/CvR87Jl7.js";import{e as ve,i as he}from"../chunks/D9U44Uqc.js";import{h as ze}from"../chunks/DCgJCFhG.js";import{s as P}from"../chunks/DRm78Km9.js";import{T as qe}from"../chunks/Do9QUcz1.js";import{p as B}from"../chunks/DBd7qnMQ.js";import{g as Ge}from"../chunks/DPegraxV.js";import{s as ge}from"../chunks/C7stL2V7.js";import{t as _e}from"../chunks/DYv-w5u2.js";const X=0,W=1,ee=2;function Ke(p,v,s,S,_){$&&Re();var i=p,g=xe(),y=He,o=re,n,l,w,I=g?ie(void 0):oe(void 0,!1,!1),D=g?ie(void 0):oe(void 0,!1,!1),x=!1;function A(t,c){x=!0,c&&(ne(e),le(e),ce(y));try{t===X&&s&&(n?fe(n):n=Q(()=>s(i))),t===W&&S&&(l?fe(l):l=Q(()=>S(i,I))),t!==X&&n&&Y(n,()=>n=null),t!==W&&l&&Y(l,()=>l=null),t!==ee&&w&&Y(w,()=>w=null)}finally{c&&(ce(null),le(null),ne(null),Pe())}}var e=Ae(()=>{if(o===(o=v()))return;let t=$&&ae(o)===(i.data===ke);if(t&&(i=Ce(),Se(i),se(!1),t=!0),ae(o)){var c=o;x=!1,c.then(b=>{c===o&&(K(I,b),A(W,!0))},b=>{if(c===o)throw K(D,b),A(ee,!0),D.v}),$?s&&(n=Q(()=>s(i))):we(()=>{x||A(X,!0)})}else K(I,o),A(W,!1);return t&&se(!0),()=>o=re});$&&(i=Le)}const Qe=async({path:p,limit:v=200,offset:s=0})=>{const _=Ge().session();try{p=p.filter(y=>y.trim()!==""),v=parseInt(Number(v).toFixed(0)),s=parseInt(Number(s).toFixed(0));const i=p.length===0?`
