import{i as P,a as C,T as D,N as _,x as u,a0 as K,L as W,R as S,Z as j,X as V,M,O as F,Q,r as q,e as H}from"./CrTysklZ.js";import{r as s,n as h,c as E,U as m}from"./DMsQp01z.js";import"./DBrWwVS6.js";import{M as L}from"./BaLsR-YP.js";import"./DSzT4ROJ.js";import{S as n}from"./Br007RDI.js";import"./C0V6bA4j.js";import"./D5LmHS4N.js";import"./5PFStWLb.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",N=i===".",B=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!N&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||N)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!N&&!U&&c.preventDefault()}},X=P`
  :host {
    width: 100%;
  }
