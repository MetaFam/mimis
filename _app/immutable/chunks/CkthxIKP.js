...
`;var k=function(t,e,i,o){var u=arguments.length,r=u<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(t,e,i,o);else for(var d=t.length-1;d>=0;d--)(c=t[d])&&(r=(u<3?c(r):u>3?c(e,i,r):c(e,i))||r);return u>3&&r&&Object.defineProperty(e,i,r),r};let R=class extends lt{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return $`
    ...
    `}templateDescription(){var i;const e=(i=this.descriptions)==null?void 0:i[0];return e?$`
        ...
        `:null}};R.styles=[$t,Vt];k([O()],R.prototype,"type",void 0);k([O({type:Array})],R.prototype,"descriptions",void 0);k([O()],R.prototype,"date",void 0);k([O({type:Boolean})],R.prototype,"onlyDirectionIcon",void 0);k([O()],R.prototype,"status",void 0);k([O()],R.prototype,"direction",void 0);k([O({type:Array})],R.prototype,"images",void 0);k([O({type:Array})],R.prototype,"price",void 0);k([O({type:Array})],R.prototype,"amount",void 0);k([O({type:Array})],R.prototype,"symbol",void 0);R=k([dt("wui-transaction-list-item")],R);const zt=ct`
  :host > wui-flex:first-child {
    column-gap: var(--wui-spacing-s);
