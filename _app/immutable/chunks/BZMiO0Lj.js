...
`;var m=function(r,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,t,e,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let g=class extends j{constructor(){super(...arguments),this.images=[],this.secondImage={type:void 0,url:""}}render(){const[t,e]=this.images,o=(t==null?void 0:t.type)==="NFT",s=e!=null&&e.url?e.type==="NFT":o,i=o?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)",n=s?"var(--wui-border-radius-xxs)":"var(--wui-border-radius-s)";return this.style.cssText=`
    ...
    `,a`<wui-flex> ${this.templateVisual()} ${this.templateIcon()} </wui-flex>`}templateVisual(){const[t,e]=this.images,o=t==null?void 0:t.type;return this.images.length===2&&(t!=null&&t.url||e!=null&&e.url)?a`<div class="swap-images-container">
      ...
      ></wui-icon-box>
    `:null}getDirectionIcon(){switch(this.direction){case"in":return"arrowBottom";case"out":return"arrowTop";default:return}}getIcon(){return this.onlyDirectionIcon?this.getDirectionIcon():this.type==="trade"?"swapHorizontalBold":this.type==="approve"?"checkmark":this.type==="cancel"?"close":this.getDirectionIcon()}getStatusColor(){switch(this.status){case"confirmed":return"success-100";case"failed":return"error-100";case"pending":return"inverse-100";default:return"accent-100"}}};g.styles=[V];m([l()],g.prototype,"type",void 0);m([l()],g.prototype,"status",void 0);m([l()],g.prototype,"direction",void 0);m([l({type:Boolean})],g.prototype,"onlyDirectionIcon",void 0);m([l({type:Array})],g.prototype,"images",void 0);m([l({type:Object})],g.prototype,"secondImage",void 0);g=m([N("wui-transaction-visual")],g);const G=_`
...
`;var w=function(r,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(r,t,e,o);else for(var c=r.length-1;c>=0;c--)(n=r[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let p=class extends j{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return a`
      <wui-flex>
        <wui-transaction-visual
          .status=${this.status}
    ...
    `}templateDescription(){var e;const t=(e=this.descriptions)==null?void 0:e[0];return t?a`
        ...
        `:null}};p.styles=[Y,G];w([l()],p.prototype,"type",void 0);w([l({type:Array})],p.prototype,"descriptions",void 0);w([l()],p.prototype,"date",void 0);w([l({type:Boolean})],p.prototype,"onlyDirectionIcon",void 0);w([l()],p.prototype,"status",void 0);w([l()],p.prototype,"direction",void 0);w([l({type:Array})],p.prototype,"images",void 0);w([l({type:Array})],p.prototype,"price",void 0);w([l({type:Array})],p.prototype,"amount",void 0);w([l({type:Array})],p.prototype,"symbol",void 0);p=w([N("wui-transaction-list-item")],p);const M=_`
  :host {
    min-height: 100%;
  }
