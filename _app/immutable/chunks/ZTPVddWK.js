import{M as p,aG as P,R as c,i as y,r as D,a as C,x as l,Z as B,e as re,d as ce,Q as h,a2 as L,aE as le,C as K,K as q,at as T,a1 as z,Y as F,G as E,aH as R,a3 as de,aI as ue,ay as pe,V as he,J as we}from"./BsreV6Dk.js";import{c as b,n as u,r as d,o as M,U as me}from"./8Hiw-s1E.js";import"./R0cYSr68.js";import"./CpfsnOLw.js";import"./Cn7oMqsn.js";import"./CHdceeOM.js";import"./DKz1JyLJ.js";import"./C4vN_pg2.js";import"./CObCh0iW.js";const ee={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){p.shake();return}if(await P.isSIWXCloseDisabled()){p.shake();return}p.close()}},fe=y`
  :host {
    display: block;
...
`;var oe=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let U=class extends C{constructor(){super(...arguments),this.imageSrc=""}render(){return l`<button>
      ${this.imageTemplate()}
    ...
    ></wui-icon-box>`}};U.styles=[D,re,ce,Ce];oe([u()],U.prototype,"imageSrc",void 0);U=oe([b("wui-select")],U);const xe=y`
  :host {
    height: 64px;
  }
...
`;var ie=function(n,e,t,i){var a=arguments.length,o=a<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,i);else for(var r=n.length-1;r>=0;r--)(s=n[r])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};const $e={loading:void 0,success:{backgroundColor:"success-100",iconColor:"success-100",icon:"checkmark"},error:{backgroundColor:"error-100",iconColor:"error-100",icon:"close"}};let j=class extends C{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=E.state.open,this.unsubscribe.push(E.subscribeKey("open",e=>{this.open=e,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t,svg:i}=E.state,a=$e[t],{icon:o,iconColor:s}=i??a??{};return l`
      <wui-snackbar
        ...
        .loading=${t==="loading"}
      ></wui-snackbar>
    `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),E.state.autoClose&&(this.timeout=setTimeout(()=>E.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};j.styles=We;ie([d()],j.prototype,"open",void 0);j=ie([b("w3m-snackbar")],j);const Ae=y`
  :host {
