import{i as P,a as C,T as D,N as _,x as u,a0 as K,L as W,R as S,Z as j,X as V,M,O as F,Q,r as q,e as H}from"./M6cbFFaq.js";import{r as s,n as h,c as E,U as m}from"./CHHLyLOr.js";import"./Cnrq4iVD.js";import{M as L}from"./BD55ImK9.js";import"./D0t7o8Ov.js";import{S as n}from"./BEhA79in.js";import"./B4N3Vdf3.js";import"./D_ceDH6Y.js";import"./CISET0De.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",N=i===".",B=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!N&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||N)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!N&&!U&&c.preventDefault()}},X=P`
  :host {
    width: 100%;
  }
