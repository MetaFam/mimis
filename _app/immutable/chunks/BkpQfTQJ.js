import{i as P,a as C,Q as D,N as _,x as u,$ as K,K as W,R as S,Y as j,V,M,L as F,O as Q,r as q,e as H}from"./CEv0nruW.js";import{r as s,n as h,c as E,U as m}from"./DqTWkdmL.js";import"./DnZe5PeF.js";import{M as L}from"./BZLk1fcc.js";import"./A6yWfi1O.js";import{S as n}from"./LDFMshfW.js";import"./C5TixpQ7.js";import"./oZ3xn8JO.js";import"./CjzOE-n9.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",N=i===".",B=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!N&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||N)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!N&&!U&&c.preventDefault()}},Y=P`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var a=arguments.length,i=a<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(a<3?r(i):a>3?r(t,e,i):r(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i};let O=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};O.styles=[Z];z([h()],O.prototype,"target",void 0);O=z([E("w3m-swap-input-skeleton")],O);const J=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
