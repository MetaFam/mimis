import{i as P,a as C,B as D,N as _,x as u,K,y as W,R as S,H as j,F as V,M,z as F,A as Q,r as q,e as H}from"./WRHwwoH-.js";import{r as s,n as h,c as E,U as m}from"./Dr37uUxP.js";import"./CKiZQZ86.js";import{M as B}from"./DLNizKGO.js";import"./P_TpJOgF.js";import{S as n}from"./BlrbBSVU.js";import"./C9JuPY7P.js";import"./D3UgHmwB.js";import"./D3HO3E6X.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",N=i===".",O=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!N&&i==="0"&&c.preventDefault(),t==="0"&&O&&(e(i),c.preventDefault()),(U||N)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!O&&!o.includes(i)&&!N&&!U&&c.preventDefault()}},X=P`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var a=arguments.length,i=a<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(a<3?r(i):a>3?r(t,e,i):r(t,e))||i);return a>3&&i&&Object.defineProperty(t,e,i),i};let L=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};L.styles=[Z];z([h()],L.prototype,"target",void 0);L=z([E("w3m-swap-input-skeleton")],L);const J=P`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
