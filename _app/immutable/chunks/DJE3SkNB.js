import{i as P,a as C,Q as D,N as _,x as u,$ as K,K as W,R as S,Y as j,V,M,L as F,O as Q,r as q,e as H}from"./BeTPpg_-.js";import{r as s,n as h,c as E,U as m}from"./BDCv2B6_.js";import"./BU7rqx6e.js";import{M as L}from"./DrfDLqXL.js";import"./R038z5Oe.js";import{S as n}from"./D4Qx_16x.js";import"./oLHMyxvd.js";import"./CuTOeaPC.js";import"./C2XrN-vg.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",R=r==="x",U=i===",",N=i===".",B=i>="0"&&i<="9";!a&&(l||x||v||R)&&c.preventDefault(),t==="0"&&!U&&!N&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(U||N)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!N&&!U&&c.preventDefault()}},Y=P`
  :host {
    width: 100%;
  }
